...
/*   Updated: 2024/05/30 01:12:31 by dnovak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// 1.	Change tolower to name of your function.
// 2.	In ft_putfncinput change number of parameters for your function
// 3.	Add your tests, don't forget to add them in ft_tolower_test
...
static int	test1(int index, int full, char *name, int c)
{
	...
	// 2. TEST
	int check = 0;
	int users = ft_tolower(c);
	int expect = tolower(c);
