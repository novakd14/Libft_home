...
/*   Updated: 2024/05/31 11:48:58 by dnovak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// 1.	Change strrchr to name of your function.
// 2.	In ft_putfncinput change number of parameters for your function
// 3.	Add your tests, don't forget to add them in ft_strrchr_test
...
static int	test1(int index, int full, char *name, char *str, int c)
{
	...
	users = ft_strrchr(str, c);
	expect = strrchr(str, c);
	if (users == expect)
		check = 1;
