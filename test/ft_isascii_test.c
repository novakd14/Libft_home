...
/*   Updated: 2024/05/29 16:29:22 by dnovak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// 1.	Change isascii to name of your function.
// 2.	In ft_putfncinput change number of parameters for your function
// 3.	Add your tests, don't forget to add them in ft_isascii_test
...
static int	test1(int index, int full, char *name, int c)
{
	...
	// 2. TEST
	int check = 0;
	int users = ft_isascii(c);
	int expect = isascii(c);
