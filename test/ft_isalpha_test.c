...
/*   Updated: 2024/05/29 16:28:05 by dnovak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// 1.	Change isalpha to name of your function.
// 2.	In ft_putfncinput change number of parameters for your function
// 3.	Add your tests, don't forget to add them in ft_isalpha_test
...
static int	test1(int index, int full, char *name, int c)
{
	...
	// 2. TEST
	int check = 0;
	int users = ft_isalpha(c);
	int expect = isalpha(c);
