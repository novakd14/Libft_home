...
{
	UNITY_BEGIN();
	RUN_TEST(test_ft_atoi_emptyString);
	RUN_TEST(test_ft_atoi_maxInt);
	RUN_TEST(test_ft_atoi_minInt);
	RUN_TEST(test_ft_atoi_minusTen);
	RUN_TEST(test_ft_atoi_minusZero);
	RUN_TEST(test_ft_atoi_one);
	RUN_TEST(test_ft_atoi_plusHundred);
	RUN_TEST(test_ft_atoi_plusZero);
	RUN_TEST(test_ft_atoi_spaces);
	RUN_TEST(test_ft_atoi_twoMinus);
	RUN_TEST(test_ft_atoi_twoPlus);
	RUN_TEST(test_ft_atoi_wierdEnd);
	RUN_TEST(test_ft_atoi_zero);
